...
$parentModule = 'PSApocalypse'
if (-not $ModuleName) { $ModuleName = 'PSApocalypse.Client' }
...
$publishRoot = Join-Path -Path $WorkingDirectory -ChildPath 'publish\PSApocalypse'
...
$originalManifestData = Import-PowerShellDataFile -Path "$publishRoot\PSApocalypse.psd1"
$prereqHash = @{
